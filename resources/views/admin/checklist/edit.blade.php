    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.checklist_groups.checklists.update',[$checklistGroup,$checklist]) }}"
                    ...
                    <div class="card-header">
                        <h4 class="m-0">{{ __('Edit Checklist of ').$checklistGroup->name }}</h4>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @livewire('task', ['checklist' => $checklist])
                </div>
            </div>
            <!-- Add New Task -->
            <div class="card">
                <div class="card-header">
                    <h4 class="m-0">{{ __('Add New Task') }}</h4>
                </div>
